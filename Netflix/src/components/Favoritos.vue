        ...
        <div id="app" class="d-flex flex-column min-vh-100">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
                    <li>
                        <button type="button" class="dropdown-item d-flex align-items-center"
                            data-bs-theme-value="light" @click="changeTheme('light')" aria-pressed="false">
                    ...
                    <li>
                        <button type="button" class="dropdown-item d-flex align-items-center active"
                            data-bs-theme-value="auto" @click="changeTheme('auto')" aria-pressed="true">
                            <svg class="bi me-2 opacity-50" width="1em" height="1em">
                                <use href="#circle-half"></use>
                            </svg>
                            Auto
            ...
            <div class="flex-fill">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div v-if="favoriteMovies.length === 0">Nenhum filme favorito encontrado.</div>
                    <div v-for="movie in favoriteMovies" :key="movie.id" class="col">
                        <div class="card shadow-sm">
                            <img :src="getPosterUrl(movie.poster_path)" class="img-fluid rounded-start"
                                :alt="movie.title" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn btn-secondary">
                                        <button @click="goToMovie(movie.id)" class="vermais-btn">Ver mais</button>
                                    </div>
    ...
    watch: {
        ...
        favoriteMovies: {
            handler(newValue) {
                ...
                localStorage.setItem('favorites', JSON.stringify(newValue.map(movie => movie.id)));
            },
            deep: true
        }
    },
    methods: {
        loadFavoriteMovies() {
            ...
            Promise.all(favoritePromises)
                .then(responses => {
                    this.favoriteMovies = responses.map(response => response.data);
